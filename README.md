...
* AES/CFB/NoPadding
    * AES_\<n\>/CFB/NoPadding, where n can be 128, 192, or 256
* AES/CFB/PKCS5Padding
    * AES_\<n\>/CFB/PKCS5Padding, where n can be 128, 192, or 256
    * PKCS7Padding is also accepted with AES/CFB and it is treated the same as PKCS5.
* RSA/ECB/NoPadding
